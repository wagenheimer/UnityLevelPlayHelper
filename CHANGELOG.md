...
### Added
- Testing tab (Test Suite one-click) and rename the menu to LevelPlay Manager

## [2.9.0] - 2026-09-22

### Added
- one-click Verify configuration (API) + reorganized Cloud tab

## [2.8.2] - 2026-09-22

### Fixed
- instance rate is mandatory (ERR-1216) + detailed activity log

## [2.8.1] - 2026-09-22

### Fixed
- disambiguate PackageInfo (UnityEditor vs PackageManager)

## [2.8.0] - 2026-09-22

### Added
- show the helper and SDK versions in the setup window header

## [2.7.0] - 2026-09-22

### Added
- dashboard cross-check in the checklist + README refresh

## [2.6.2] - 2026-09-22

### Fixed
- only show Create application when there is no app; ensure networks instead of duplicating

## [2.6.1] - 2026-09-22

### Fixed
- add missing using System for Action in the credentials panel

## [2.6.0] - 2026-09-22

### Added
- fix setup tab layout, add credential check and network guidance

## [2.5.0] - 2026-09-22

### Added
- create application from the Cloud tab

## [2.4.1] - 2026-09-22

### Fixed
- compile fixes for the Cloud tab
...
### Changed
- chore(editor): English-only strings in the setup UI

## [2.3.0] - 2026-09-22

### Added
- single LevelPlay Setup & Config window (credentials + checklist)

## [2.2.1] - 2026-09-22

### Fixed
- add missing CredentialValidation.cs.meta

## [2.2.0] - 2026-09-22

### Added
- always flag missing/invalid credentials in the helper inspector
...
### Fixed
- unify the Tools menu and harden credential/ad-unit checks

## [2.0.1] - 2026-09-22

### Fixed
- add missing Runtime/UI.meta so the debug overlay is not ignored
